...
namespace KorpPat
{
    ...
    public class TRexRunnerGame : Game
    {
        ...
        public TRexRunnerGame(Activity1 activity1, double scaleWidth, double scaleHeight)
        {
        ...
        protected override void LoadContent()
        {
            ...
            _inputController = new InputController(_trex, _activity1);
            ...
            _gameOverScreen = new GameOverScreen(_spriteSheetTexture, this, _activity1);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Begin(transformMatrix: Matrix.CreateScale((float)_scaleWidth, (float)_scaleHeight, 1.0f));
        ...
        public void SaveGame()
        {
            ...
            _activity1.HighScore = _scoreboard.HighScore;
            _activity1.HighScoreDate = _highscoreDate;
        ...
        public void LoadSaveState()
        {
            ...
            _scoreboard.HighScore = _activity1.HighScore;
