...
namespace TRexGame.Entities
{
    public class GameOverScreen : IGameEntity
    {
        ...
        private KorpPat.TRexRunnerGame _game;
        ...
        Android.Widget.Button _restartButton;

        public bool IsEnabled { get; set; }
        public GameOverScreen(Texture2D spriteSheet, KorpPat.TRexRunnerGame game, Activity1 activity1)
        {
            _activity1 = activity1;
            _restartButton = (Android.Widget.Button)_activity1.FindViewById(KorpPat.Resource.Id.button_restart);
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if ((RestartButtonBounds.Contains(mouseState.Position) && mouseState.LeftButton == ButtonState.Pressed)
                || (wasKeyPressed && !isKeyPressed) || _restartButton.Pressed)
            {
                _game.Replay();
            }
